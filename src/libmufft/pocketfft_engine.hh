...
namespace muFFT {
  ...
  class PocketFFTEngine : public FFTEngineBase {
   public:
     ...
     *
     * This constructor initializes a PocketFFTEngine object with the given
     ...
     *
     * This constructor initializes a PocketFFTEngine object with the given
     * number of grid points and FFT planner flags. The constructor does not
     ...
     * planner flags.
     * @param allow_temporary_buffer A boolean flag indicating whether
     * the creation of temporary buffers is allowed if the input buffer has the
     * wrong memory layout. Defaults to true.
