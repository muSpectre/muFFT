...
namespace muFFT {
    ...
    class PFFTEngine : public FFTEngineBase {
       public:
         ...
         * @param allow_destroy_input allow that the input buffers are
         * invalidated during the FFT
         */
        ...
        /**
         * need to override this method here, since FFTWMPI requires field
         * padding
         */
        RealField_t &
       ...
       protected:
        ...
        //! holds the fourier field sizes including padding for different
        //! transforms
