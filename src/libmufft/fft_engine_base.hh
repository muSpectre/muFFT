...
namespace muFFT {
    ...
    public:
         ...
         * number of grid points, communicator, ghost buffers, FFT planner flags,
         * and buffer options. The constructor does not perform any FFT computations;
         * it merely sets up the object for future FFT operations.
         *
         ...
         * @param nb_ghosts_left Number of ghost cells on the left (low index) side of
         * the simulation cell. Defaults to no ghost cells.
         * @param nb_ghosts_right Number of ghost cells on right (high index) side of
         * the simulation cell. Defaults to no ghost cells.
